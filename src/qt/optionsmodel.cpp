...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nAnonymizeXapxAmount"))
        settings.setValue("nAnonymizeXapxAmount", 1000);

    nAnonymizeXapxAmount = settings.value("nAnonymizeXapxAmount").toLongLong();
...
// Wallet
    ...
    if (settings.contains("nAnonymizeXapxAmount"))
        SoftSetArg("-anonymizeapollonamount", settings.value("nAnonymizeXapxAmount").toString().toStdString());
